<nav class="navbar navbar-expand-xl navbar-light bg-white shadow-sm sticky-lg-top">
    <div class="container">
        <a class="navbar-brand d-flex" href="{{ url('') }}">
            <img src="{{ asset('imgs/9atratAmal.svg') }}" class="pb-2" alt="9atrat Amal logo" height="40px">
            <span class="mx-2">|</span>
            <img src="{{ asset(Lang::locale() === 'ar' ? 'imgs/9atratAmalLogo.png' : 'imgs/9atratAmalLogoAscii.png' ) }}" alt="9atrat Amal Logo" height="{{ LaravelLocalization::getCurrentLocale() === 'ar' ? '40px' : '35px' }}">
        </a>
